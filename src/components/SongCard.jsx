...
const SongCard = ({ song, onPlay }) => {
  return (
    ...
    >
      {/* Song Image */}
      <div className="relative overflow-hidden rounded-2xl border border-[#E6DDC6] bg-linear-to-br from-[#FAF7EE] via-[#F6F1E3] to-[#ECE6D5] p-4 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
        {/* Put your song image here */}
        <img
          src={song?.banner}
          alt={song?.title}
        ...
        <div className="absolute inset-0 flex items-center justify-center rounded-2xl bg-black/20 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
          <button
            ...
            className="flex h-14 w-14 scale-90 items-center justify-center rounded-full bg-[#FFDB58] text-neutral-800 shadow-xl transition-all duration-300 group-hover:scale-100 hover:bg-[#f5cf4a]"
          >
